...
# Use Get-ADUser to filter and retrieve only 250 active users in **Department Code** with specified properties
$Users = Get-ADUser -Filter {Enabled -eq $true -and Department -eq "Department Code"} -Properties $Properties -ResultSetSize 250 |
